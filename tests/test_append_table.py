...
#workbook = load_workbook(filename='eeg_gsr_wellness_tracker/Mood_Focus_Table.xlsx')
#workbook.sheetnames
...
def read_raw_eeg_file(eeg_file_path):
    ...
    file = '/Users/barlehmann/desktop/AusEC.edf'
    filename = '/Users/barlehmann/desktop/AusEC.edf'
    first_ten_values = [-1.21509270e-05, -1.13508659e-05, -1.09508354e-05]
    #first_value = ['4.62613']
    data = mne.io.read_raw_edf(file)
    raw_data = data.get_data()
    assert first_10_values == raw_data[:2]
