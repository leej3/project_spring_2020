...
default_swarmdir='/data/MoodGroup/07M0021_meg_analysis/MID_data/scripts/swarm/'
...
default_sublist=default_swarmdir +'processinglist.txt'
...
def make_swarm_newDs(subjectlist=default_sublist, origds=default_origds, newds=default_newds, marker=default_marker, timewindow=default_timewindow,swarmdir=default_swarmdir):
...
def make_swarm_sam(subjectlist=default_sublist, ds=default_ds, marker=default_marker, freqband=default_freqband,swarmdir=default_swarmdir):
	#read list of subjects	
	sublist=open(subjectlist, 'r')
