...
pd.read_excel(r'/Users/harveycas/Documents/FAES/Python class/python_test_list.xlsx')

#This function is to call in an excel document from your computer for this program.  Make sure that the path to the excel document is correct and the "r'" is necessary for the code to work
...
#This is a code that sorts all of the NAT values in the document.  It sorts the positive (which is represented by a 1) from the negative (which is marked by a 0)  
...
#This is required to create a new dataframe using the sorted data. The second line of code converts the data into an excel document that will end up on your computer's library
...
#This is a code that sorts all of the HYG values in the document.  It sorts the positive (which is represented by a 1) from the negative (which is marked by a 0) 
...
#This is a code that sorts all of the URA values in the document.  It sorts the positive (which is represented by a 1)from the negative (which is marked by a 0) 
...
#This organizes the three previous dataframes ('NAT_plus', 'HYG_plus', and 'URA_plus') as their own sheet in the  new major excel document 'Antibiotic_markers'
